...
from cardano_node_tests.tests.tests_conway.test_drep import get_custom_drep
from cardano_node_tests.tests.tests_conway.test_drep import get_payment_addr
from cardano_node_tests.tests.tests_conway.test_drep import get_pool_user
...
class TestConwayExtras:
    """Starting Class for Extra Conway Tests."""
    ...
    def test_drep_no_retirement_before_register(
        ...
        * check it is not possible to retire before register
        ...
        err_msg = str(excinfo_submit.value if excinfo_submit else excinfo_cli.value)
        assert (
    ...
    def test_info_return(
        ...
        * Check deposit is returned
        ...
        for _ in range(gov_action_lifetime):
            cluster.wait_for_new_epoch(padding_seconds=5)
